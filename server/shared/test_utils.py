...
class MongoTestCase(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        try:
            ...
            test_url = os.getenv("MONGODB_TEST_URL", "mongodb://admin:password123@localhost:27017")
            ...
            try:
                ...
                raise unittest.SkipTest(f"No MongoDB available for testing. Install Docker for testcontainers or start MongoDB locally. Error: {e}")
    ...
    def assert_collection_count(self, collection_name, expected_count, use_history=False):
        """
    ...
    def assert_document_exists(self, collection_name, query, use_history=False):
        ...
        self.assertIsNotNone(
            doc, 
            f"Document matching {query} not found in {db_type}.{collection_name}"
        )
        return doc
    ...
    def assert_banished_correctly(self, table_enum, object_id):
        ...
        self.assertIsNone(main_doc, f"Document {object_id} still exists in main database")
        ...
        self.assertTrue(hist_doc.get('banished', False), "Document not marked as banished")
        self.assertIsNotNone(hist_doc.get('banished_on'), "Document missing banished_on timestamp")
...
class MongoTestCaseWithoutContainer(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        try:
            ...
            raise unittest.SkipTest(f"No MongoDB available for testing. Please start MongoDB locally. Error: {e}")
